...
$dbParams = require 'AppEngine/Domains/Users/Config/migrations-db.php'; // Adjust the path if necessary

// Define paths to your entity directories
$paths = ["AppEngine/Domains/Users/Entities"];
$isDevMode = true;
...
$config = new PhpFile('AppEngine/Domains/Users/Config/migrations.php'); // Adjust the path if necessary

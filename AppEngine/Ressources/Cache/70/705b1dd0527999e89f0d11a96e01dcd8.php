...
/* userlist.twimm.php */
class __TwigTemplate_3f28595caa7b744c783b6591c582bc01 extends Template
{
    private $source;
    private $macros = [];
    ...
    {
        $macros = $this->macros;
        $this->parent = $this->loadTemplate("home.layout.php", "userlist.twimm.php", 1);
...
{% endblock %}", "userlist.twimm.php", "C:\\xampp\\htdocs\\TWIMMENGINE\\AppEngine\\Ressources\\Views\\userlist.twimm.php");
    }
}
